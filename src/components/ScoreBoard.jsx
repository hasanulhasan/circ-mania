...
const ScoreBoard = () => {
  ...
  const {data, isLoading} = useGetInningsQuery();
  ...
  return (
    <>
    <h1 className="text-center text-4xl font-semibold my-6">Bangladesh vs Australia first T20</h1>
    {
      isLoading? <>
    ...
    <div className='max-w-6xl flex flex-col items-center mt-8 border-2 p-4 mx-auto rounded-md'>
      <h1 className='text-3xl text-center font-semibold my-4'>Third umpire section</h1>
        ...
        <button onClick={handleRest} className="w-72 inline-block px-8 py-4 font-bold text-red uppercase border-2 border-red-600 rounded-md hover:bg-red-500 hover:text-white mt-4">Reset</button>
    </div>
    </>
    }
    </>
